...
import { KeyRound, Mail, LogIn, ArrowRight, CheckSquare } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 relative">
      ...
      <div className="glass-panel-heavy w-full max-w-md p-8 rounded-3xl shadow-2xl border border-slate-800/80 transition-all duration-300">
        <div className="text-center mb-8">
          ...
          <h2 className="font-display font-bold text-2xl tracking-wide text-white">Welcome Back</h2>
          <p className="text-xs text-slate-400 mt-2">Log in to prioritize and manage your tasks</p>
        </div>
